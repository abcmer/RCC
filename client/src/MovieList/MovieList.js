...
const headCells = [
  { id: 'title', numeric: false, disablePadding: true, label: 'Film Title' },
  { id: 'awardShowYear', numeric: true, disablePadding: false, label: 'Award Show Year' },
];
...
export default function MovieList(props) {
  const {movies, moviesWatched, setMoviesWatched} = props;
  let rows = [];
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.awardShowYear}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
